...
❖ ϻᴧᴅє ʙʏ  ➠ [ꜱᴛᴅ](https://t.me/stdbotz) **
'''
    HELP_PROMOTION = '''
**─────────────────────────
...
'''
    HELP_ALLBOT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[˹ꜱᴛᴅ ꭙ ʀσʙσᴛ˼](https://t.me/stdbotz)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
       ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
─────────────────────────

╭⎋ [˹ꜱᴛᴅ ꭙ ʀσʙσᴛ˼ ♪ [ ɴᴏ ♡゙ ᴧᴅꜱ ](https://t.me/stdxrobot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
       
─────────────────────────
⊚ ʙσᴛ sᴛᴧᴛυs ᴧηᴅ ϻσʀє ʙσᴛs - [ᴄʟɪᴄᴋ ϻє](https://t.me/stdbotz)
─────────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 14 mar 2025 
─────────────────────────
❍ ᴘσᴡєʀєᴅ ʙʏ ⁚ ˹ [ᴄʟɪᴄᴋ ϻє](https://t.me/stdbotz) ˼
─────────────────────────**
'''
    HELP_ABOUT = '''
**─────────────────────────
...
● ᴧɪ ɪηᴛєɢʀᴧᴛɪση
─────────────────────────
❖ υᴘᴅᴧᴛєs ᴄʜᴧηηєʟ ➥ [ᴄʟɪᴄᴋ ϻє](https://t.me/stdbotz)
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [ᴄʟɪᴄᴋ ϻє](https://t.me/stdxsupport)
❖ ʀєᴧʟ σᴡηєʀ ➥ [ᴄʟɪᴄᴋ ϻє](https://t.me/teamstdnetwork)
❖ ʀєᴘσ ʟɪηᴋ ➥ [ᴄʟɪᴄᴋ ϻє](https://t.me/stdnetwork)
─────────────────────────
