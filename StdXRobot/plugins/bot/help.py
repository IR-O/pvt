...
from StdXRobot.utils import help_pannel
from StdXRobot.utils.database import get_lang
from StdXRobot.utils.decorators.language import LanguageStart, languageCB
from StdXRobot.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from StdXRobot.help.buttons import BUTTONS
from StdXRobot.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_STD, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
